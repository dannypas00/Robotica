...
class RobotController {
  ...
  private:
  webots::Robot *robot; /// @brief The WeBots Robot instance of the controller.
  
  WheelController* wheel_controller; /// @brief The instance of the WheelController.
  ArmController* arm_controller; /// @brief The instance of the ArmController.
  
  webots::Camera *camera; /// @brief The instance of the WeBots Camera.
  webots::TouchSensor *touch_sensor; /// @brief The instance of the WeBots TouchSensor.
