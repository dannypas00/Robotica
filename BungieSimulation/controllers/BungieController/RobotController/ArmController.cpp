...
ArmController::ArmController(webots::Robot* robot, const double velocity)
  : robot(robot),
    motors {
      ...
      robot->getMotor("left_claw_rotation_motor"), robot->getMotor("right_claw_rotation_motor")
    },
    positionSensors {
      ...
      robot->getPositionSensor("left_claw_rotation_sensor"), robot->getPositionSensor("right_claw_rotation_sensor")
    },
    velocity(velocity)
{
