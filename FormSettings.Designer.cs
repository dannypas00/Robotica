namespace Client_side
{
    partial class FormSettings
    {
        ...
        private void InitializeComponent()
        {
			...
			// groupBox2
			// 
			this.groupBox2.Controls.Add(this.PictureBox_Connected);
